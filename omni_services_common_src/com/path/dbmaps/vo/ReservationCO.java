...
public class ReservationCO extends BaseVO implements Cloneable {
...
////////////////////**********Mohannad*****************////////////////
	...
	private Time maxTimeToReachDestination;

	private Time timeFromDestinationToClient;

	private String timeString;

	private Time timeToExpire;
	...
	private String FormuleCost;

	private double userDriverDistance;

	/*
	 * 1 confirmed , 0 not confirmed
	 */
	private int confirmReservation;

	/*
	 * 0: reservation by phone 1 : quick reservation start 2: tlubtuk
	 */
	...
	private int fromThread;

	public int getFromThread() {
		return fromThread;
	}

	public void setFromThread(int fromThread) {
	...
	public int getConfirmReservation() {
		return confirmReservation;
	}

	public void setConfirmReservation(int confirmReservation) {
	...
	public Time getMaxTimeToReachDestination() {
		return maxTimeToReachDestination;
	}

	public void setMaxTimeToReachDestination(Time maxTimeToReachDestination) {
		this.maxTimeToReachDestination = maxTimeToReachDestination;
	}

	public Time getTimeFromDestinationToClient() {
		return timeFromDestinationToClient;
	}

	public void setTimeFromDestinationToClient(Time timeFromDestinationToClient) {
		this.timeFromDestinationToClient = timeFromDestinationToClient;
	}
	...
	public Time getTimeToExpire() {
		return timeToExpire;
	}

	public void setTimeToExpire(Time timeToExpire) {
...
//	}
	...
	public String getFormuleCost() {
		return FormuleCost;
	}

	public void setFormuleCost(String formuleCost) {
		FormuleCost = formuleCost;
	}

	public double getUserDriverDistance() {
		return userDriverDistance;
	}

	public void setUserDriverDistance(double userDriverDistance) {
		this.userDriverDistance = userDriverDistance;
	}
	...
	public ReservationCO cloneReservationCO() throws CloneNotSupportedException {
		ReservationCO reservationCO = (ReservationCO) super.clone();
