...
public class ParamLovSC extends BaseVO {
	...
	/*
	 * 0 does not has brockers , 1 has brockers
	 */
	private int hasBrokers;
	...
	public int getHasBrokers() {
		return hasBrokers;
	}

	public void setHasBrokers(int hasBrokers) {
		this.hasBrokers = hasBrokers;
	}
