 ...
 *
 *          OmniCommonUserCO.java used to
 */
public class OmniCommonUserCO extends OmniBaseVO
{
    ...
    private List<OmniCommonUserCO> channelActivationChargesGridDataList=new ArrayList<>();
    ...
    public List<OmniCommonUserCO> getChannelActivationChargesGridDataList()
    {
        return channelActivationChargesGridDataList;
    }

    public void setChannelActivationChargesGridDataList(List<OmniCommonUserCO> channelActivationChargesGridDataList)
    {
