...
public class NestedMapXstreamConverter implements Converter {
	...
	@SuppressWarnings("unchecked")
	private void mapToXML(HierarchicalStreamWriter writer,
			Entry<String, ?> entry) {
	...
	private Map<String, List<Object>> xmlToMap(HierarchicalStreamReader reader,
